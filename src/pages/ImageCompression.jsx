...
function ImageCompression({ ffmpegRef }) {
  const {
    onDrop,
    onCompress,
  ...
  return (
    <div className="mt-10 flex flex-col items-center">
      <div className="text-center  mt-3 mb-5 p-2">
        <h2 className="text-2xl font-bold mb-2">Image Compression</h2>
        <p className="text-lg">
      ...
      <div className="flex bg-[#EFEEF3] w-[10%] sm:w-[700px] items-center px-3 py-3">
        <p className="flex-1 uppercase font-bold text-gray-700">
          Added {files.length} files{" "}
        </p>
        <button
          onClick={() =>
            onCompress(["-c:v", "mjpeg", "-compression_level", "10"])
          }
